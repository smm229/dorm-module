...
class CreateDormitoryStayrecordsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_dorm')->create('dormitory_stayrecords', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('positionName')->nullable()->comment('职务');
            $table->string('departmentName')->nullable()->comment('部门');
        ...
        \Illuminate\Support\Facades\DB::connection('mysql_dorm')->statement("ALTER TABLE `dormitory_stayrecords` comment '住宿历史表'");
    }
    ...
    {
        Schema::connection('mysql_dorm')->drop('dormitory_stayrecords', function (Blueprint $table) {
