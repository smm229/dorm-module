...
class CreateDormitoryUsersGroupTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dormitory_users_group', function (Blueprint $table) {
            $table->increments('id');
            $table->unsignedTinyInteger('type')->nullable()->default(1)->comment('类型1学生2老师3访客4黑名单');
        ...
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `dormitory_users_group` comment '用户关联用户组'");
    }
