...
class CreateDormitoryGuestAccessRecordTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dormitory_guest_access_record', function (Blueprint $table) {
            ...
            $table->string('avatar', 255)->nullable()->comment('底库图片');
        ...
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `dormitory_guest_access_record` comment '访客通行记录'");
    }
    ...
    {
        Schema::dropIfExists('dormitory_guest_access_record');
    }
}
