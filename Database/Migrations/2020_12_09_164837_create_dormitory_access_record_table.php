...
class CreateDormitoryAccessRecordTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_dorm')->create('dormitory_access_record', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->unsignedTinyInteger('sex')->nullable()->default(1)->comment('性别1男2女3保密');
        ...
        \Illuminate\Support\Facades\DB::connection('dormitory_access_record')->statement("ALTER TABLE `dormitory_access_record` comment '通行记录'");
    }
    ...
    {
        Schema::connection('mysql_dorm')->drop('dormitory_access_record', function (Blueprint $table) {
