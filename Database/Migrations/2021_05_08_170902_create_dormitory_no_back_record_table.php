...
class CreateDormitoryNoBackRecordTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dormitory_no_back_record', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('build_name', 20)->nullable();
        ...
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `dormitory_no_back_record` comment '未归记录'");
    }
    ...
    {
        Schema::dropIfExists('dormitory_no_back_record');
    }
}
