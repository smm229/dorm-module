...
class CreateDormitoryAccessRecordTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('dormitory_access_record', function (Blueprint $table) {
            ...
            $table->string('floor', 100)->nullable()->comment('楼层');
            $table->string('room_num', 100)->nullable()->comment('房间');
            $table->string('bed_num', 100)->nullable()->comment('床位');
            ...
            $table->string('avatar', 255)->nullable()->comment('识别人员的底库图片');
    ...
    {
        Schema::dropIfExists('dormitory_access_record');
    }
}
